    ...
    class NegativeFilterTestCaseContainer : IEnumerable<object[]>
    {
        ...
        private static AdvancedFilterSetting[] GetNegativeEventTypeFilterConfigurations()
        {
            return new[] {
               ...
               new AdvancedFilterSetting { Key = "EventType", OperatorType = AdvancedFilterSetting.OperatorTypeEnum.StringNotIn, Values = new object[] { "Not-the-right-type", "this.is.a.test.event.type" } }
            };
        }
        ...
        private static AdvancedFilterSetting[] GetNegativeEventDataFilterConfigurations()
        {
            return new[] {
               ...
               new AdvancedFilterSetting { Key = "Data.NumberValue", OperatorType = AdvancedFilterSetting.OperatorTypeEnum.NumberIn, Values = new object []{ 1.1, 2, 3.5, "stringValue", true } },
               ...
               new AdvancedFilterSetting { Key = "Data.NumberValue", OperatorType = AdvancedFilterSetting.OperatorTypeEnum.NumberNotIn, Values = new object []{ 0, 1, 2, 3.5, "stringValue", true } },
               ...
               new AdvancedFilterSetting { Key = "Data.NumberValue", OperatorType = AdvancedFilterSetting.OperatorTypeEnum.NumberNotIn, Values = new object []{ 0, 2, 3.5, "stringValue", true } },
