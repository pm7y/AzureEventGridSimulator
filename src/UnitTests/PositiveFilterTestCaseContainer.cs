    ...
    class PositiveFilterTestCaseContainer : IEnumerable<object[]>
    {
        ...
        private static AdvancedFilterSetting[] GetPositiveIdFilterConfigurations()
        {
            return new[]
            {
                ...
                new AdvancedFilterSetting { Key = "Id", OperatorType = AdvancedFilterSetting.OperatorTypeEnum.StringBeginsWith, Value = "Event" },
                new AdvancedFilterSetting { Key = "Id", OperatorType = AdvancedFilterSetting.OperatorTypeEnum.StringBeginsWith, Value = "EVE" }, // according to the spec, string comparisons in advanced mode are always case insensitive
        ...
        private static AdvancedFilterSetting[] GetPositiveEventTypeFilterConfigurations()
        {
            return new[] {
                ...
                new AdvancedFilterSetting { Key = "EventType", OperatorType = AdvancedFilterSetting.OperatorTypeEnum.StringIn, Values = new object[] { "this.is.a.test.event.type" } },
