...
* the Docker image now runs as the non-root 'app' user (UID 1654). Mounted certificates and config files must be readable by that user, and mounted dead-letter or log folders writable by it (see the wiki's Docker page).
...
* resolve seven bugs found in the repo review ([#321](https://github.com/pm7y/AzureEventGridSimulator/issues/321)) ([cb075ea](https://github.com/pm7y/AzureEventGridSimulator/commit/cb075ead184105c1a4bb5f52fc095019a6abee2e))
* resolve the remaining repo review items ([#322](https://github.com/pm7y/AzureEventGridSimulator/issues/322)) ([05f2047](https://github.com/pm7y/AzureEventGridSimulator/commit/05f2047a3532dc0ee06f2b06ccd334081f9c7762))
...
* **nuget:** Bump the minor-and-patch group with 5 updates ([#320](https://github.com/pm7y/AzureEventGridSimulator/issues/320)) ([544f783](https://github.com/pm7y/AzureEventGridSimulator/commit/544f783587270e9b342a2f6d01982c5adf4a2492))
